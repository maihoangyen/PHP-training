...
#### 8. Ý nghĩa và chức năng của các hàm trong trang bình luận <a name="binhluan"></a>
   ...
   -  `htmlspecialchars` hàm này chuyển các thể html trong chuỗi tương ứng sang  dạng thực thể của chúng.Các ký tự được xác định trước là:
...
#### 9. Bổ sung thêm các hàm trong php <a name="binhluan"></a>
